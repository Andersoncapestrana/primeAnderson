...
Logar no aplicativo com a conta x
    ...
    Input Text                           xpath=//android.widget.EditText[@resource-id="identifierId"]        corvino.kyrium@gmail.com
    ...
    Input Password                       xpath=//android.view.View[@resource-id="password"]//android.widget.EditText                                     Ck.0123456789
    Click Element                        xpath=//android.widget.Button[@text="PRÓXIMA"]
